...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cifs_server_2

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cifs_server_2: ${OBJECTFILES}
...
${OBJECTDIR}/file_attr.o: file_attr.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file_attr.o file_attr.cpp
...
${OBJECTDIR}/myiconv.o: myiconv.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myiconv.o myiconv.cpp
...
${OBJECTDIR}/trans2.o: trans2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trans2.o trans2.cpp

${OBJECTDIR}/trans2_subcommand.o: trans2_subcommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trans2_subcommand.o trans2_subcommand.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cifs_server_2
